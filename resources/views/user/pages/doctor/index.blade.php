            ...
            <div class="col-4 mb-3">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <div class="card-text">{{ $doctor->phone }}</div>
                        <div class="text-center">
                            <a href="{{ route('user.doctor.show', ['doctor' => $doctor->id, 'specialization' => $doctor->specialization_id]) }}" class="btn btn-success">Check Availability</a>
                        </div>
                    </div>
                </div>
            </div>
